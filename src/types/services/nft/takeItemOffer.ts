...
export const EvmTakeItemOfferParamsWithExtras = z.object({
  chain: ZodEvmBlockchain.describe('The chain to take the item offer on'),
  items: z.array(EvmTakeItemOfferParams).describe('The take item offer parameters'),
});
...
export type EvmTakeItemOfferParams = z.infer<typeof EvmTakeItemOfferParamsWithExtras>;
